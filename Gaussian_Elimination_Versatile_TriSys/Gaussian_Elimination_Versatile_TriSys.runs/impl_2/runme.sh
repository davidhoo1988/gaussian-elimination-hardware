...
HD_PWD='C:/Users/Hu Jingwei/Dropbox/ROLLO/hardware/Gaussian_Elimination_Versatile_TriSys/Gaussian_Elimination_Versatile_TriSys.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log comb_SA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_SA.tcl -notrace
