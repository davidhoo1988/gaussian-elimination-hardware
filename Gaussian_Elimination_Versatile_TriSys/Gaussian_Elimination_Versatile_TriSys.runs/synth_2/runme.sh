...
HD_PWD='C:/Users/Hu Jingwei/Dropbox/ROLLO/hardware/Gaussian_Elimination_Versatile_TriSys/Gaussian_Elimination_Versatile_TriSys.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log comb_SA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_SA.tcl
